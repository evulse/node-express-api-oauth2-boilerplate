...
var Console, EventSource, Events, File, HTML, History, JSDOM, Screen, URL, WebSocket, XMLHttpRequest, createDocument, createWindow, inContext, loadDocument;
...
createWindow = function(_arg) {
  var browser, closed, document, encoding, eventQueue, global, history, method, name, opener, params, parent, url, window, windowHistory;
  browser = _arg.browser, params = _arg.params, encoding = _arg.encoding, history = _arg.history, method = _arg.method, name = _arg.name, opener = _arg.opener, parent = _arg.parent, url = _arg.url;
  name || (name = "");
  url || (url = "about:blank");
...
loadDocument = function(_arg) {
  var browser, document, done, encoding, headers, history, method, params, pathname, protocol, referer, url, window, _ref;
