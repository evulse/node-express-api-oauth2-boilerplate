...
XMLHttpRequest = (function() {
  ...
  XMLHttpRequest.prototype.send = function(data) {
    ...
    this._window._eventQueue.http(request.method, request.url, request, function(error, response) {
      var document, listener, mimeType;
      ...
      _this.responseText = response.body;
      ...
      if (response.headers["content-type"]) {
        ...
        if (/^text\/(html|xml)$/.test(mimeType)) {
          try {
            ...
            document.close();
            _this.responseXML = document;
          } catch (error) {
            _this._window.console.error("Failed to parse XML response: " + error.message);
          }
        }
      }
